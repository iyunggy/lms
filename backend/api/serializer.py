...
class CourseSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        fields = ["id", "category", "teacher", "file", "video_url", "image", "title", "description", "price", "language", "level", "platform_status", "teacher_course_status", "featured", "course_id", "slug", "date", "students", "curriculum", "lectures", "average_rating", "rating_count", "reviews",]
